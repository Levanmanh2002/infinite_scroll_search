...
ProductModels _$ProductModelsFromJson(Map<String, dynamic> json) => ProductModels(
...
Map<String, dynamic> _$ProductModelsToJson(ProductModels instance) => <String, dynamic>{
      'id': instance.id,
      ...
      'reviews': jsonEncode(instance.reviews?.map((e) => e.toJson()).toList()),
